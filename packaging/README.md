...
For every Asterline release, update the Formula version, archive URLs, and
SHA-256 values. For the AUR package, resolve the annotated tag to its commit,
pin that commit and its archive SHA-256, update `pkgver`/`pkgrel`, then
